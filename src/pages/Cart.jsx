...
const Cart = () => {
  const { cart, cartTotal, cartCounter } = useCart();
    ...
    <>
      <div className="container mx-auto px-4 md:px-8 pt-8 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10  ">
          ...
          <div className="lg:col-span-1 p-8 bg-gray-900 rounded-2xl border-l-4 sticky top-20 h-fit border border-gray-800  ">
            ...
            <Link
              to={"/checkout"}
              className="flex mt-8 items-center justify-center space-x-2  transform hover:ring-4 mx-auto w-full py-4 bg-orange-600 text-white font-extrabold text-xl  rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300  "
            >
              <Zap className="w-5 h-5" />
              <span>proced Secure </span>
            </Link>
